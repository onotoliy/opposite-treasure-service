...
public class TreasureDebtRecord extends UpdatableRecordImpl<TreasureDebtRecord> implements Record2<UUID, UUID> {

    private static final long serialVersionUID = -114513299;
